...
export default function WorksheetGeneratorForm({ sidebar }: { sidebar: React.ReactNode }) {
  ...
  const formSnapshot = JSON.stringify({ curriculum, yearGroup, mixed, subject, learningObjective, questionTypes, questionCount, abilityLevel, outputDetail, additionalInfo });
