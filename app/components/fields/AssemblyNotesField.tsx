...
export default function AssemblyNotesField({ value, onChange }: Props) {
  const placeholder = useTypingPlaceholder([
    "e.g. Include a reference to our school motto",
    "e.g. Link to Black History Month",
    "e.g. Tie in to our current PSHE topic on mental health",
    "e.g. Mention the upcoming charity fundraiser",
  ]);
  return (
