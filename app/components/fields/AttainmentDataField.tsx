...
export default function AttainmentDataField({ value, onChange }: Props) {
  const placeholder = useTypingPlaceholder([
    "e.g. Struggles with evaluation work, strong at recording reasoning, working at grade D",
    "e.g. Secure at procedural tasks, gaps in applying knowledge to unseen problems",
    "e.g. Report comment: inconsistent effort; can produce excellent work when focused",
  ]);
  return (
