...
export default function MeetingTopicsField({ value, onChange }: Props) {
  const placeholder = useTypingPlaceholder([
    "e.g. Assessment data review, upcoming parents' evening",
    "e.g. Changes to the SEND referral process, timetable updates",
    "e.g. Curriculum sequencing audit, new staff induction",
    "e.g. Behaviour policy rollout, pupil progress review",
  ]);
  return (
