...
export default function TopicField({ value, onChange }: Props) {
  const placeholder = useTypingPlaceholder(["e.g. Quadratic equations", "e.g. The Water Cycle", "e.g. Shakespeare's Macbeth"]);
  return (
